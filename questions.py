questions = [
        ...
        ['Выберите асимптотику работы фунцкции sort() из библиотеки algorithm', 'keys', '!n*log(n)', 'n', 'n^2'],
...
# типы: keys, free(ответ не имеет значения), full
# "ключ":"free"
# "ключ":"full|важное_слово1/важное_слово2/важное_слово3/важное_слово4"
# "ключ":"keys|ответ1/ответ2/ответ3/!ответ4"; ! - правильный ответ
# ["ключ", 'тип_вопроса', 'ответ1', 'ответ2', 'ответ3', 'ответ4']
