...
success_message = "Все ваши ответы приняты, ожидайте пока вам напишет специалист. Спасибо за уделенное время"
failed_message = "Спасибо за прохождение тестирования! Мы вам перезвоним"